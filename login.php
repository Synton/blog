...
<div align="center"> <form action="blogLogin.php" method="post" name="formLogin"> 
    <table align="center" id="rcorners"> 
      <tbody>
        ...
        <tr> 
          <td colspan="2" align="center"> <input type="reset" value="Reset" /> <input id="submit" onclick="checkFields()" type="submit" value="Abschicken" /> </td> 
        </tr> 
      </tbody>
    </table> </form> 
</div> </body>
